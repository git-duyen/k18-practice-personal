...
test('Fill Info Register Page', async ({ page }) => {
  ...
  const data = {
    ...
    country: 'Canada',
    dob: '2000-12-06',
    avatar: 'tests/student-submission/thanh-tu/lesson-10/data-test/ava.jpeg',
    biography: 'lorem ipsum dolor sit amet consectetuer adipiscing elit sed diam nonummy',
    rating: '9',
    color: '#e4eb1e',
  };
  ...
  await test.step('Fill Info', async () => {
    ...
    await registerPage.checkGender(data.gender.toLocaleLowerCase() === 'male' ? 'male' : 'female');
