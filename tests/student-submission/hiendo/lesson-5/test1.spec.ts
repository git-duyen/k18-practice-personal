...
const testData = {
    ...
    dob: '01011999',
    file: 'tests\student-submission\hiendo\data-test\file1.txt',
...
test('register_with_valid_information', async ({ page }) => {
    ...
    await test.step('Fill out the registration form', async () => {
        ...
        await page.locator("//textarea[@id='bio']").fill(testData.bio);
        ...
        await page.locator("//input[@id='customDate']").fill(testData.customDate);
    });
